...
OutputBaseFilename=CrashLens-Setup-0.1.5
Compression=lzma2
...
Source: "..\docs\images\crashlens.ico"; DestDir: "{app}"; DestName: "CrashLens-0.1.5.ico"; Flags: ignoreversion
...
[Icons]
Name: "{group}\CrashLens"; Filename: "{app}\{#AppExeName}"; IconFilename: "{app}\CrashLens-0.1.5.ico"
Name: "{autodesktop}\CrashLens"; Filename: "{app}\{#AppExeName}"; WorkingDir: "{app}"; IconFilename: "{app}\CrashLens-0.1.5.ico"
